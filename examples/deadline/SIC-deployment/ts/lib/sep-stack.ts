...
/**
 * Properties for {@link DeadlineStack}.
 */
export interface DeadlineStackProps extends StackProps {
...
export class DeadlineStack extends Stack {

  /**
   * Initializes a new instance of DeadlineStack.
   * @param scope The scope of this construct.
   * @param id The ID of this construct.
   * @param props The stack properties.
   */
  constructor(scope: Construct, id: string, props: DeadlineStackProps) {
